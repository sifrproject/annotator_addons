...
import edu.stanford.smi.protegex.owl.ui.actions.OWLProperties;
public class AO {
	...
	public static  void test(){
		...
		Model m = ModelFactory.createDefaultModel();
		 ...
		 String annPrefix ="http://www.w3.org/2000/10/annotation-ns#";
		 ...
		 Property type = m.createProperty(rdfPrefix+"type");
		 
		 Resource ExactQualifierResource = m.createResource( "&aot;ExactQualifier" );
	...
	public static  void test2()
	{
			   ...
			   InputStream in =new  FileInputStream(inputFile);
			    if (in == null) {   System.out.println("File not found"); }  
			     model.read(in," ");
